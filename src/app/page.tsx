...
export default function Home() {
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        <header style={{ padding: '16px 24px', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', backgroundColor: 'var(--bg-secondary)' }}>
          <button className="secondary-button" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: 0 }} onClick={() => setAppState("DASHBOARD")}>
  ...
  return (
    <main>
      ...
      {appState === "QUESTION_PLAYER" && renderQuestionPlayer()}
    </main>
  );
}
